...
namespace Pagina_web_sistema_de_ventas
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand("  Select count(*) From Usuarios1 where Id_usuario=@Usuarios  ", conexion);
            conexion.Open();
            ...
            {
                comando.Parameters.AddWithValue("@Usuarios", Convert.ToInt32(TextBox1.Text));
